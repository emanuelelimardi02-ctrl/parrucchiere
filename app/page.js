...
const services = [
  { icon: '✂', title: 'Hair', items: [['Taglio Capelli', '€20,00'], ['Taglio Bimbo (0-5 anni)', '€15,00']] },
  { icon: '◒', title: 'Beard', items: [['Modellatura Barba', '€10,00'], ['Taglio + Barba', '€25,00']] },
